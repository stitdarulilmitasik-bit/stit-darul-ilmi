@php $kalenderAkademik = $kalender ?? collect(); @endphp
@extends('core-themes.core-mainpage')

@section('custom-css')
    <style>
        .hero-section {
            background: linear-gradient(135deg, rgba(var(--tblr-success-rgb), 0.8), rgba(var(--tblr-primary-rgb), 0.9)) no-repeat center center;
