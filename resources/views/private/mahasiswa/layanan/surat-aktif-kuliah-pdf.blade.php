...
*{box-sizing:border-box}body{font-family:DejaVu Sans,Arial,sans-serif;font-size:10.2pt;line-height:1.32;color:#111;margin:0}.kop{border-bottom:3px solid #111;padding-bottom:6px;margin-bottom:10px}.kop-table{width:100%;border-collapse:collapse}.kop-logo{width:125px;text-align:center;vertical-align:middle}.kop-logo img{width:110px;height:110px;object-fit:contain}.kop-text{text-align:center;vertical-align:middle}.kop-text .a{font-size:13.5pt;font-weight:bold}.kop-text .b{font-size:17pt;font-weight:bold}.kop-text .c{font-size:9pt}.kop-text .d{font-size:8.4pt}.title{text-align:center;font-weight:bold;font-size:12.5pt;text-decoration:underline;margin-top:3px}.nomor{text-align:center;margin:2px 0 10px}.row{display:table;width:100%;margin:2px 0}.label{display:table-cell;width:178px;vertical-align:top}.value{display:table-cell;vertical-align:top}.section{margin:7px 0 3px}.date-right{text-align:right;margin-top:8px}.ttd{width:100%;margin-top:5px;border-collapse:collapse}.ttd td{vertical-align:top}.right{text-align:center;width:43%}.signature-space{height:52px}.tembusan{margin-top:9px;font-size:8.8pt}.small{font-size:8.8pt}
</style>
</head>
<body>
...
<table class="ttd"><tr><td></td><td class="right">{{ $pejabat_jabatan }}<div class="signature-space"></div><strong><u>{{ $pejabat_nama }}</u></strong><br>NIP/NIK. {{ $pejabat_nip }}</td></tr></table>
