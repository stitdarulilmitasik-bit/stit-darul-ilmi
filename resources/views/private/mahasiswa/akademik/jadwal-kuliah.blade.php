                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item {{ !request()->has('semester') ? 'active' : '' }}" 
                               href="{{ route('mahasiswa.akademik.jadwal') }}">
                                Semester Aktif
                            </a>
                            <div class="dropdown-divider"></div>
                            @foreach(($availableSemesters ?? collect()) as $semester)
                                <a class="dropdown-item {{ request('semester') == $semester->id ? 'active' : '' }}" 
                                   href="{{ route('mahasiswa.akademik.jadwal.semester', $semester->id) }}">
                                    {{ $semester->nama ?? $semester->name ?? '' }} - {{ $semester->tahun_ajaran ?? $semester->type ?? '' }}
                                </a>
                            @endforeach
                        </div>
                    </div>
