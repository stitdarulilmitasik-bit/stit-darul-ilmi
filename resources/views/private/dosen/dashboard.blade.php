...
<div class="container-xl py-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">Berikut ringkasan aktivitas akademik dan jadwal perkuliahan Anda di STIT Darul Ilmi Tasikmalaya.</p>
                        </div>
                        <div class="flex-shrink-0">
    ...
    {{-- Jadwal dosen ditampilkan paling atas agar langsung terlihat setelah login --}}
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h3 class="card-title mb-1">Jadwal Saya</h3>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table schedule-table">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th>Hari</th>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card stat-card bg-info text-white h-100"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div><h6 class="mb-1">Jadwal Kuliah</h6><h2 class="mb-0">{{ number_format($totalEvents) }}</h2></div><div class="stat-icon bg-white bg-opacity-25"><i class="fas fa-calendar-alt fa-2x"></i></div></div><div class="mt-3 small">Jadwal yang Anda ampu</div></div></div>
        </div>
    </div>
