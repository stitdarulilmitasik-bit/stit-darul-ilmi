...
<head>
    ...
    <title>SIAKAD STIT Darul Ilmi — Setup Wizard</title>
                ...
                <div class="p-8">
                    ...
                    <div class="wizard-step active" id="step1">
                        <div class="text-center">
                            ...
                            <h2 class="text-3xl font-bold text-gray-900 mb-4">Selamat Datang di SIAKAD STIT Darul Ilmi</h2>
                            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                                Siapkan konfigurasi awal Sistem Informasi Akademik STIT Darul Ilmi.
