                    ...
                    <div class="gallery-grid" id="galleryGrid">
                        @forelse($galeris ?? [] as $galeri)
                            <div class="gallery-card card" data-category="{{ $galeri->kategori_id }}" data-name="{{ $galeri->name }}">
                                ...
                                @endif
                                <img src="{{ stit_gallery_image_url($galeri->photo) }}" class="card-img-top" alt="{{ $galeri->name }}" loading="lazy" onerror="this.onerror=null;this.src='{{ asset('images/placeholders/news-placeholder.svg') }}'">
