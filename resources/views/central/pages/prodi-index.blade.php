...
@section('custom-css')
    <style>
        .hero-section {
            background: linear-gradient(135deg, rgba(var(--tblr-primary-rgb), 0.85), rgba(var(--tblr-info-rgb), 0.9)) no-repeat center center;
...
@section('content')
    ...
    <section class="hero-section text-white">
        <div class="container hero-content">
            ...
            <p class="hero-subtitle">Temukan program studi yang tersedia di STIT Darul Ilmi Tasikmalaya sesuai dengan informasi akademik yang telah ditetapkan kampus.</p>
