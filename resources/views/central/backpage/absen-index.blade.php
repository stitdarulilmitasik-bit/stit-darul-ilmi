                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <h6>Foto Masuk</h6>
                                                                <img src="{{ stit_storage_image_url('images/absensi', $item->photo_in) }}" class="img-fluid rounded mb-2" alt="Absensi Masuk">
                                                            </div>
                                                            @if($item->photo_out)
                                                            <div class="col-md-6">
                                                                <h6>Foto Pulang</h6>
                                                                <img src="{{ stit_storage_image_url('images/absensi', $item->photo_out) }}" class="img-fluid rounded mb-2" alt="Absensi Pulang">
                                                            </div>
                                                            @endif
                                                        </div>
                                                    </div>
