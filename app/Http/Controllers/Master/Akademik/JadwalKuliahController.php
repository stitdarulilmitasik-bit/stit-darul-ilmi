...
class JadwalKuliahController extends Controller
{
    ...
    public function getWaktuKuliahByJenisKelas($jenisKelasId)
    {
        $jenis=JenisKelas::with('waktuKuliah')->findOrFail($jenisKelasId);
        return response()->json($jenis->waktuKuliah);
    }
